...
export default function ProductDetails() {
    ...
    const getFetchData = async () => {
        ...
        setProductsList(ab.find((e) => e.id === priduct_id))
    }
        ...
        <>
            <div className='w-full px-10 mx-auto grid grid-cols-2 gap-4 mt-32'>
                <div className='pr-20 mt-10'>
                    ...
                    <h2 className='font-bold text-4xl'>{productsList.name}</h2>
                    <div className='flex mt-5 mb-5'>
                        <h4 className='mr-4'>${productsList.discountPrice}    </h4>
                        {/* <Rating value={4} readonly /> */}
                    </div>
                    <p className='text-gray-700 mb-5 '>{productsList.des}</p>
                    <div className='flex '>
                ...
                <div>
                    <img className='rounded-lg w-full pr-8' src={productsList.link} alt="" />
                </div>
            </div>
            <div className='mt-32'>
